...
import com.jamesaworo.stocky.entity.settings.SettingNotification;
 ...
 * @since 4/20/23
 */
public interface SettingNotificationDao extends JpaRepository<SettingNotification, Long> {
