...
public enum AppModuleEnum {
    AUTHENTICATION {
        ...
        public String pageIcon() { return "appstore"; }
    },
    COMPANY {
        public List<AppModuleRoute> pageRoute() {
            return List.of(
        ...
        public String pageIcon() { return "shop"; }
    },
    PEOPLE {
        public List<AppModuleRoute> pageRoute() {
            return List.of(
        ...
        public String pageIcon() { return "team"; }
    },
    PRODUCT {
        public List<AppModuleRoute> pageRoute() {
            return List.of(
        ...
        public String pageIcon() { return "shopping-cart"; }
    },
    STOCK {
        public List<AppModuleRoute> pageRoute() {
            return List.of(
        ...
        public String pageIcon() { return "appstore-add"; }
    },
    REPORT {
        public List<AppModuleRoute> pageRoute() {
            return List.of(
        ...
        public String pageIcon() { return "file-pdf"; }
    },
    SETTING {
        public List<AppModuleRoute> pageRoute() {
            return List.of(
        ...
        public String pageIcon() { return "setting"; }
    },
    SALE {
        public List<AppModuleRoute> pageRoute() {
            return List.of(
        ...
        public String pageIcon() { return "credit-card"; }
    },
    SUBSCRIPTION {
        public List<AppModuleRoute> pageRoute() {
            return List.of(
        ...
        public String pageIcon() { return "wallet"; }
    };
